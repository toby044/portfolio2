<template>
    <div
        class="c-aside-menu fixed top-0 left-0 min-w-16 h-screen"
        ref="$el"
    ...
    >
        ...
        <div class="relative h-full flex flex-col justify-between items-center">
            <NuxtLink
                ...
                :to="item.url"
                :key="idx"
                class="c-aside-menu-link relative w-full h-1/3 transition-colors duration-200 font-medium flex grow items-center justify-center p-4"
                :class="{
                    'rounded-full ': idx !== 1,
